...
//        String usuario="postgres", password="2468", iP="localhost", puerto="5432", nombreBD="pruebareflection";

        public Conexion(String usuario, String password, String ip, String puerto, String nombreBD){
...
//    Statement st=conexion.createStatement();
	...
	public void cerrar() throws SQLException{
        ...
        public Connection getConnection() {
            return this.conexion; // Suponiendo que tu conexión se guarda en una variable llamada "conexion"
        }
